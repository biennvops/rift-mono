...
class _OnboardingScreenState extends State<OnboardingScreen> {
              ...
              child: PageView(
                ...
                children: [
                  ...
                  _buildOnboardingCard(
                    ...
                    iconBgColor: theme.colorScheme.primaryContainer.withValues(alpha: 0.2),
                    iconColor: theme.colorScheme.primary,
                    title: 'Local Network',
                    description: 'Rift requires local network access to securely discover and synchronize with nearby trusted devices over encrypted channels.',
                    infoTag: 'MANDATORY FOR CORE FUNCTIONALITY',
                    actions: [
                      _buildPrimaryButton('Grant Permission', theme, _nextPage),
                    ],
                  ),
                  ...
                  _buildOnboardingCard(
                    ...
                    title: 'Alerts & Logs',
                    description: 'Enable push notifications to receive real-time alerts on unauthorized access attempts and device sync status.',
                    actions: [
                      _buildPrimaryButton('Enable Alerts', theme, _nextPage),
                  ...
                  _buildOnboardingCard(
                    ...
                    iconBgColor: theme.colorScheme.tertiaryContainer.withValues(alpha: 0.2),
                    iconColor: theme.colorScheme.tertiary,
                    title: 'Background Sync',
                    description: 'To maintain continuous secure clipboard syncing, Rift must run in the background without battery optimization restrictions.',
  ...
  Widget _buildPrimaryButton(String text, ThemeData theme, VoidCallback? onPressed, {bool isProcessing = false}) {
    return SizedBox(
  ...
  Widget _buildOutlinedButton(String text, ThemeData theme, VoidCallback onPressed) {
    return SizedBox(
      width: double.infinity,
