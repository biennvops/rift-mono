...
import 'package:app_flutter/src/media_playback/windows_remote_media_playback_coordinator.dart';
...
void main() {
  ...
  group('JsonRpcRiftClient', () {
    ...
    test('Windows mirrors playback state and routes native transport actions',
        () async {
