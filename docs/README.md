...
- `capstone-register.md` - project register and requirements baseline
- `known-issues.md` - open technical limitations and follow-up items
...
- `../spec/examples/README.md` - example artifacts and message flows
...
- `clipboard-desktop-runtime-checklist.md` - real-host verification checklist for Windows, Linux, and macOS clipboard bridges
- `clipboard-platform-support.md` - current clipboard support matrix across Windows, Linux, macOS, and Android
...
- `wiki-ingestion.md` - what future wiki builders should include and exclude
- `wiki-input.txt` - explicit path manifest for wiki ingestion
- `archive/README.md` - historical material retained for context only
