...
- `0012-mobile-native-tls-transport.md` - native mobile TLS transport boundary
- `0013-user-session-file-publication.md` - daemon staging and user-session file publication
